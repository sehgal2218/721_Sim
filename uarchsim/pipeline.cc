...
//REN = new renamer(NXPR + NFPR, prf_size, num_chkpts, rob_size,PERFECT_VALUE_PRED,VPQ_SIZE,ORACLE_CONF,SVP_INDEX_BITS,SVP_TAG_BITS,SVP_CONF_MAX,VP_ELIGIBLE_INTALU,VP_ELIGIBLE_FPALU,VP_ELIGIBLE_LOAD,VP_GSHARE_EN,GSHARE_INDEX_BITS,GSHARE_TAG_BITS,GSHARE_CONF_MAX,GSHARE_HISTORY_BITS); 
REN = new renamer(NXPR + NFPR, prf_size, num_chkpts, rob_size,PERFECT_VALUE_PRED,VPQ_SIZE,ORACLE_CONF,SVP_INDEX_BITS,SVP_TAG_BITS,SVP_CONF_MAX,VP_ELIGIBLE_INTALU,VP_ELIGIBLE_FPALU,VP_ELIGIBLE_LOAD,VP_GSHARE_EN,GSHARE_INDEX_BITS,GSHARE_TAG_BITS,GSHARE_CONF_MAX,GSHARE_HISTORY_BITS);
