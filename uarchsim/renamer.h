...
{
	bool dst_flag;
	uint64_t logical_dst_reg;
	uint64_t physical_dst_reg;
	bool completioin_flag;
	bool exp_flag;
	bool load_violation_flag;
	bool branch_mispred_flag;
	bool value_mispred_flag;
	bool load_flag; 
 	bool store_flag;
	bool branch_flag;
	bool amo_flag;
...
private:
	...
	/////////////////////////////////////////////////////////////////////
	uint64_t logical_reg_count;
	uint64_t physical_reg_count;
	uint64_t unresolved_branch_count;
...
bool is_vp_perfect();
bool is_vp_oracle();
uint64_t get_prediction_value(int index);
